...
cl /nologo /std:c++17 /permissive- /EHsc /W4 /MT /O2 /DWIN32_LEAN_AND_MEAN /DNOMINMAX /D_CRT_SECURE_NO_WARNINGS /I "%ROOT%\src" "%ROOT%\tests\physics_selftest.cpp" "%ROOT%\src\GL.cpp" "%ROOT%\src\InlineHook.cpp" "%ROOT%\src\Log.cpp" /Fe:physics_selftest.exe /link opengl32.lib user32.lib gdi32.lib
