...
//
// tomb123.exe statically imports WINMM.dll, so a winmm.dll dropped in the game
...
// be stepped through.
//
// Only the ten functions tomb123.exe actually imports are forwarded. Anything
...
// --- thunked exports --------------------------------------------------------
// The exact ten tomb123.exe imports, confirmed by reading the PE import
// directory. Tomb Raider I-III Remastered imports the SAME ten winmm functions
// as IV-VI did -- waveOutOpen/Reset/Close/Write/PrepareHeader/UnprepareHeader
// and timeGetTime/BeginPeriod/EndPeriod/GetDevCaps -- so this file carries over
// from the TR4-6 mod unchanged apart from these comments.
